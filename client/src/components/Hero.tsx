...
function Hero({ ImgOne, ImgTwo, title, heading, btnText, onClick }: HeroProps) {
  return (
    <main className="w-full flex flex-col bg-slate-200 py-10 px-20">
      <section className="flex flex-col lg:flex-row items-center justify-center">
        <div className="flex-1 text-white py-5 text-left">
          ...
          <h1 className="text-[1.5rem] text-red-600  md:text-[3rem] font-bold font-noto">
            {title}
          </h1>
        </div>
        <div className="flex-1 my-5 lg:my-0">
          <div className="relative w-full">
            <span
              className="absolute z-10 w-full  h-full inline-block bg-slate-100 left-0 top-0"
      ...
      <section className="flex flex-col lg:flex-row  justify-between items-center">
        <Clickable onClick={onClick} styles="bg-red-600 w-full md:w-[30rem]  ">
